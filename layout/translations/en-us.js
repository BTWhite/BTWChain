...
window.Translations['en-us'] = {
    ...
    DELEGATE_REGISTER: 'Reg. Delegate',
    ...
    INFO_1: 'At the moment there were no new translations to your wallet',
    INFO_2: 'At the moment you are not participating in this program',
    ...
    ERR_VIOLATE_BIP39: 'The password format does not conform to the BIP39 security specification',
    ERR_SERVER_ERROR: 'Server error!',
    ERR_PASSWORD_NOT_EQUAL: 'The main password you entered is not consistent',
    ERR_DELEGATE_NAME_EMPTY: 'Delegate name should not empty',
    ERR_DELEGATE_NAME_ADDRESS: 'Delegate name should not be address',
    ERR_DELEGATE_NAME_FORMAT: 'The trustee name is not formatted correctly',
    ERR_SECOND_PASSWORD_FORMAT: 'The second-level password input format is incorrect',
    ERR_NO_RECIPIENT_ADDRESS: 'The address must be entered',
    ERR_RECIPIENT_ADDRESS_FORMAT: 'The receiving address is not formatted correctly',
    ERR_RECIPIENT_EQUAL_SENDER: 'Accept the address and send address can not be the same',
    ERR_AMOUNT_INVALID: 'The sending amount is incorrectly entered',
    ERR_BALANCE_NOT_ENOUGH: 'Insufficient balance',
    ERR_NO_SECND_PASSWORD: 'You must enter a secondary password',
    ERR_TWO_INPUTS_NOT_EQUAL: 'Two input inconsistencies',
    ERR_PASSWORD_INVALID_FORMAT: 'The password is not formatted correctly',
    ERR_AT_LEAST_SELECT_ONE_DELEGATE: 'Please select one at least',
    ERR_DELETE_NO_MORE_THAN_33: 'Delete up to 33 candidates at a time',
    ERR_VOTE_NO_MORE_THAN_33: 'One vote for up to 33 candidates',
    ...
    ERR_TOAST_SECONDKEY_WRONG: 'Failed to verify second signature (Invalid transaction amount)',
    ERR_TOAST_ASSET_NOTEXIST: 'Asset not exists',
    ERR_TOAST_ASSET_INSUFFICIENT: 'Insufficient asset balance',
    ERR_TOAST_VOTE_LIMIT: 'Voting limit exceeded. Maximum is 33 votes per transaction',
    ERR_TOAST_ACCOUNT_ALREADY_LOCKED: 'Account is locked',
    ERR_TOAST_ACCOUNT_INVALID_RECIPIENT: 'Invalid recipient',
    ERR_TOAST_ACCOUNT_INVALID_TIMESTAMP: 'Account invalid timestamp',
