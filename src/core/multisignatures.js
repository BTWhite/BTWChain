...
const RequestSanitizer = require('../utils/request-sanitizer.js');
...
function Multisignature() {
    ...
    this.apply = function (trs, block, sender, cb) {
        __cur.unconfirmedSignatures[sender.address] = false;
    ...
    this.undo = function (trs, block, sender, cb) {
        ...
        __cur.unconfirmedSignatures[sender.address] = true;
        library.base.account.merge(sender.address, {
    ...
    this.applyUnconfirmed = function (trs, sender, cb) {
        if (__cur.unconfirmedSignatures[sender.address]) {
